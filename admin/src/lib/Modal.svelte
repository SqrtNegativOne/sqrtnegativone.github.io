...
{#if open}
  ...
  >
    ...
    >
      <!-- Header -->
      <div class="px-6 py-4 border-b border-[oklch(0.2739_0.0055_286.03)] flex justify-between items-center bg-[oklch(0.1603_0.0059_285.89)]">
        <div>
      ...
      <!-- Footer -->
      {#if footer}
        <div class="px-6 py-4 border-t border-[oklch(0.2739_0.0055_286.03)] flex justify-end items-center gap-3 bg-[oklch(0.1603_0.0059_285.89)]">
          {@render footer()}
        </div>
      {/if}
    </div>
