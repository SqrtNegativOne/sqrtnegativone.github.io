...
<div class="space-y-6">
  <div class="flex justify-between items-center">
    <div>
      ...
      <p class="text-[#94a3b8] mt-2">Manage your portfolio projects and apps.</p>
    </div>
  ...
  <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
    {#each data.projects as item}
      <div class="card flex flex-col md:flex-row group relative overflow-hidden">
        ...
        <div class="w-full md:w-48 h-48 md:h-auto bg-[#0f172a] shrink-0 border-b md:border-b-0 md:border-r border-[#334155] relative overflow-hidden">
          {#if item.image}
          ...
          {:else}
            <div class="w-full h-full flex items-center justify-center text-[#94a3b8]">No Image</div>
          {/if}
          {#if item.private}
  ...
  {#if data.projects.length === 0}
    <div class="card p-8 text-center text-[#94a3b8]">No projects found. Add some!</div>
  {/if}
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-2 flex items-center pt-8">
            <label class="flex items-center space-x-3 cursor-pointer">
              <input type="checkbox" name="private" value="true" checked={currentItem.private} class="w-5 h-5 rounded border-[#334155] bg-[#0f172a] text-blue-500 focus:ring-blue-500 focus:ring-offset-[#1e293b]" />
              <span class="text-sm font-medium text-[#94a3b8]">Private Project</span>
            </label>
          </div>
        </div>
