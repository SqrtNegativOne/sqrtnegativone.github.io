    ...
    <div class="bg-[oklch(0.2795 0.0368 260.03)] border border-[oklch(0.3717 0.0392 257.29)] rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
      ...
      <div class="flex-1 overflow-y-auto p-6 flex flex-col">
        <form id="save-media-form" method="POST" action="?/save" use:enhance={() => {
          ...
          <div class="space-y-2">
            <label for="media-id" class="block text-sm font-medium text-[oklch(0.7107 0.0351 256.79)]">ID (Unique)</label>
          ...
          <div class="space-y-2">
            <label for="media-type" class="block text-sm font-medium text-[oklch(0.7107 0.0351 256.79)]">Type</label>
          ...
          <div class="space-y-2">
            <label for="media-title" class="flex justify-between items-end block text-sm font-medium text-[oklch(0.7107 0.0351 256.79)]">
              <span>Title</span>
          ...
          <div class="space-y-2 md:col-span-2">
            <label for="media-subtitle" class="block text-sm font-medium text-[oklch(0.7107 0.0351 256.79)]">Subtitle (Optional)</label>
          ...
          <div class="space-y-2 md:col-span-2">
            <label for="media-desc" class="block text-sm font-medium text-[oklch(0.7107 0.0351 256.79)]">Description</label>
          ...
          <div class="space-y-2 md:col-span-2">
            <label for="media-private" class="flex justify-between items-end block text-sm font-medium text-[oklch(0.7107 0.0351 256.79)]">
          ...
          <div class="space-y-2">
            <label for="media-status" class="block text-sm font-medium text-[oklch(0.7107 0.0351 256.79)]">Status</label>
          ...
          <div class="space-y-2">
            <label for="media-rating" class="block text-sm font-medium text-[oklch(0.7107 0.0351 256.79)]">Rating (1-7)</label>
          ...
          <div class="space-y-2">
            <label for="media-poster" class="block text-sm font-medium text-[oklch(0.7107 0.0351 256.79)]">Poster Image URL</label>
        ...
        <div class="mt-8 flex justify-between items-center pt-4 border-t border-[oklch(0.3717 0.0392 257.29)]">
          <div>
            {#if isEditing}
